            ...
            <div className="container-fluid">
                <div className="row light">
                    ...
                    <div className="cd-fixed-bg cd-bg-5 header-img supporting-header">
                            ...
                            <div className="supporting-description">
                                ...
                                <div className="col-xs-12 col-sm-12 col-md-6 col-lg-6 supporting-right-column no-top-padding no-padding-bottom">
                                    <div className="no-padding-bottom supporting-center">
                                        <h3 className="fade-in sup-context margin-top-6 mobile-320">Speedway has rewind capacity available to turn distressed material into a valuable resource custom made to your specifications.</h3>
                        ...
                        <div className="action tape-action-container mobile-320">
                            <div className="row">
